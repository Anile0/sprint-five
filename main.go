...
func (w Walking) Calories() float64 {
	mInSec := math.Pow((w.meanSpeed()*KmHInMsec), 2) * CmInM
	// вставьте ваш код ниже
	return ((CaloriesWeightMultiplier*w.Weight + (mInSec/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
